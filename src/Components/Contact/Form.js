            ...
            <Grid container spacing={{ md: 2, sm: 3, xxs: 2 }}>
                ...
                <Grid item md={3} sm={6} xxs={12}>
                    <Box sx={{ position: 'relative' }}>
                        ...
                        <Box sx={{ position: 'absolute', right: '10px', top: '50%', transform: 'translateY(-50%)', pointerEvents: 'none' }}>
                             ▼
                        </Box>
                    </Box>
                    {errors.service && (
                        <Typography variant='body1' component='p' sx={styles.ErrorMessage}>
                            <ErrorIcon /> Please Select a Service!
                        </Typography>
                    )}
                </Grid>
                <Grid item md={3} sm={6} xxs={12}>
                    ...
                    {errors.budget && (
                        <Typography variant='body1' component='p' sx={styles.ErrorMessage}>
                            <ErrorIcon /> Please Select a Budget!
                        </Typography>
                    )}
                </Grid>
                <Grid item xxs={12}>
                    <InputBase
                        ...
                        {...register(
                            'message',
                            {
                                required: 'Please add your project description!',
                                minLength: {
                                    value: 25,
                                    message: 'Description should not be less than 25 characters!',
                                },
                            },
                            { required: true }
                        )}
